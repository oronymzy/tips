...
- The `markdown_extensions` setting [specifies](https://www.mkdocs.org/user-guide/configuration/#markdown_extensions) the [Python-Markdown extensions](https://python-markdown.github.io/extensions/) for MkDocs.
    ...
    - The `codehilite` entry point enables the [Python-Markdown](https://python-markdown.github.io/extensions/code_hilite/) [Pygments](http://pygments.org/) [syntax highlighting](https://en.wikipedia.org/wiki/Syntax_highlighting) extension.  
    Additional documentation is available for [Material for MkDocs](https://squidfunk.github.io/mkdocs-material/extensions/codehilite/), including [a list of supported languages](https://squidfunk.github.io/mkdocs-material/extensions/codehilite/#supported-languages-excerpt). The strings required for each language can be found at [the raw text source](https://raw.githubusercontent.com/squidfunk/mkdocs-material/master/docs/extensions/codehilite.md) of [the CodeHilite page](https://github.com/squidfunk/mkdocs-material/blob/master/docs/extensions/codehilite.md) on GitHub.

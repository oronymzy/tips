...
|:------------------------------------------------------------------------------------|:--------------------------|:-----------------------------------------------------------------------|:-----------------------------------------------|:-------------------------|:------------------------------------------------|:-----------------------------------------------|:---------------------------------------|:----------------------------------------------------------|
|{: .fth } [admonition]                                                               | no{: .no}                 | no{: .no}                                                              | no{: .no}                                      | no{: .no}                | no{: .no}                                       | no{: .no}                                      | yes (with extension){: .yes}[^pynadmo] | no{: .no}                                                 |
|{: .fth } [blockquote]                                                               | yes{: .yes}               | yes{: .yes}[^ghfmblq]                                                  | yes{: .yes}[^glfmblq]                          | yes{: .yes}[^jgmblkq]    | yes{: .yes}[^pdmblkq]                           | yes{: .yes}                                    | yes{: .yes}                            | yes{: .yes}[^somblq1] [^somblq2]                          |
|{: .fth } [break]  [(hard line, with a backslash)][hard line break with a backslash] | yes{: .yes}               | yes{: .yes}[^ghfmbks]                                                  | no{: .no}                                      | no{: .no}                | yes (with an extension){: .yes}[^pdmbhlk]       | no{: .no}                                      | no{: .no}                              | no{: .no}                                                 |
|{: .fth } [break]  [(hard line, with two spaces)][hard line break with two spaces]   | yes{: .yes}               | yes{: .yes}[^ghfmbks]                                                  | yes{: .yes}[^glfmbks]                          | yes{: .yes} [^jgmbhls]   | yes{: .yes}[^pdmbhlk]                           | yes{: .yes}[^pymbhls]                          | yes{: .yes}                            | yes{: .yes}[^sombhls]                                     |
|{: .fth } [break]  [(thematic)][thematic break]                                      | yes{: .yes}               | yes{: .yes}[^ghfmtbk]                                                  | yes{: .yes}[^glfmtbk]                          | yes{: .yes}[^jgmtbrk]    | yes{: .yes}[^pdmtbrk]                           | yes{: .yes}                                    | yes{: .yes}                            | yes{: .yes}[^somtbrk]                                     |
|{: .fth } [code]  [(fenced block)][fenced block of code]                             | yes{: .yes}               | yes{: .yes}[^ghfmfcb]                                                  | yes{: .yes}[^glfmfcb]                          | no{: .no}                | yes (with extension){: .yes}[^pdmfcdb]          | yes (with extension){: .yes}[^pymexra]         | yes (with extension){: .yes}[^pyncodb] | no{: .no}                                                 |
|{: .fth } [code]  [(indented block)][indented block of code]                         | yes{: .yes}               | yes{: .yes}[^ghfmicb]                                                  | yes{: .yes}[^glfmicb]                          | yes{: .yes}[^jgmcodb]    | yes{: .yes}[^pdmicdb]                           | yes (with extension){: .yes}[^pymexra]         | yes{: .yes}                            | yes{: .yes}[^somicdb]                                     |
|{: .fth } [code]  [(inline)][inline code]                                            | yes{: .yes}               | yes{: .yes}[^ghfmcdi]                                                  | yes{: .yes}[^glfmcdi]                          | yes{: .yes}[^jgmcodi]    | yes{: .yes}[^pdmcodi]                           | yes{: .yes}                                    | yes{: .yes}                            | yes{: .yes}                                               |
|{: .fth } [emphasis]                                                                 | yes{: .yes}               | yes{: .yes}[^ghfmems]                                                  | yes{: .yes}[^glfmems]                          | yes{: .yes}[^jgmemph]    | yes{: .yes}[^pdmemph]                           | yes{: .yes}                                    | yes{: .yes}                            | yes{: .yes}[^somemph]                                     |
|{: .fth } [footnote]  [(inline-style)][inline-style footnote]                        | no{: .no}                 | no{: .no}                                                              | no{: .no}                                      | no{: .no}                | yes (with extension){: .yes}[^pdmftnt]          | partial (with extension){: .partial}[^pymfnis] | no{: .no}[^pynfnis]                    | no{: .no}                                                 |
|{: .fth } [footnote]  [(reference-style)][reference-style footnote]                  | no{: .no}                 | no{: .no}                                                              | yes{: .yes}[^glfmrsf]                          | no{: .no}                | yes (with extension){: .yes}[^pdmftnt]          | yes (with extension){: .yes}[^pymexra]         | yes (with extension){: .yes}[^pynfnrs] | no{: .no}                                                 |
|{: .fth } [heading]  [(ATX-style)][ATX-style heading]                                | yes{: .yes}               | yes{: .yes}[^ghfmhda]                                                  | yes{: .yes}[^glfmhdg]                          | yes{: .yes}[^jgmhdng]    | yes{: .yes}[^pdmatxh]                           | yes{: .yes}                                    | yes{: .yes}                            | no{: .no}                                                 |
|{: .fth } [heading]  [(Setext-style)][Setext-style heading]                          | yes{: .yes}               | yes{: .yes}[^ghfmhds]                                                  | yes{: .yes}[^glfmhdg]                          | yes{: .yes}[^jgmhdng]    | yes{: .yes}[^pdmstxh]                           | yes{: .yes}                                    | yes{: .yes}                            | yes{: .yes}[^somstxh]                                     |
|{: .fth } [image]                                                                    | yes{: .yes}               | yes{: .yes}[^ghfmimg]                                                  | yes{: .yes}[^glfmimg]                          | yes{: .yes}[^jgmimag]    | yes{: .yes}[^pdmimag]                           | yes{: .yes}                                    | yes{: .yes}                            | yes{: .yes}[^somimag]                                     |
|{: .fth } [inline HTML]                                                              | yes{: .yes}               | partial (some tags are filtered out){: .partial} [^ghfmht1] [^ghfmht2] | partial (whitelist only){: .partial}[^glfmhtm] | yes{: .yes}[^jgmhtml]    | yes (with extension){: .yes}[^pdmhtml]          | yes{: .yes}                                    | yes{: .yes}                            | partial (whitelist only){: .partial}[^somhtm1] [^somhtm2] |
|{: .fth } [link]  [(automatic)][automatic link]                                      | yes{: .yes}               | yes{: .yes}[^ghfmla1] [^ghfmla2]                                       | no{: .no}                                      | yes{: .yes}[^jgmlkao]    | yes{: .yes}[^pdmlkao]                           | yes{: .yes}                                    | yes{: .yes}                            | yes{: .yes}[^somlkao]                                     |
|{: .fth } [link]  [(inline-style)][inline-style link]                                | yes{: .yes}               | yes{: .yes}[^ghfmlki]                                                  | yes{: .yes}[^glfmlnk]                          | yes{: .yes}[^jgmlink]    | yes{: .yes}[^pdmlkis]                           | yes{: .yes}                                    | yes{: .yes}                            | yes{: .yes}[^somlink]                                     |
|{: .fth } [link]  [(reference-style)][reference-style link]                          | yes{: .yes}               | yes{: .yes}[^ghfmlkr]                                                  | yes{: .yes}[^glfmlnk]                          | yes{: .yes}[^jgmlink]    | yes{: .yes}[^pdmlkrs]                           | yes{: .yes}                                    | yes{: .yes}                            | yes{: .yes}[^somlink]                                     |
|{: .fth } [list]  [(attribute list)][attribute list]                                 | no{: .no}                 | no{: .no}                                                              | no{: .no}                                      | no{: .no}                | partial (with extensions){: .partial}[^pdmlatr] | no{: .no}                                      | yes (with extension){: .yes}[^pynlatr] | no{: .no}                                                 |
|{: .fth } [list]  [(description list)][description list]                             | no{: .no}                 | no{: .no}                                                              | no{: .no}                                      | no{: .no}                | yes (with extension){: .yes}[^pdmldsc]          | yes (with extension){: .yes}[^pymexra]         | yes (with extension){: .yes}[^pynldsc] | no{: .no}                                                 |
...
[GitLab Flavored Markdown]: https://docs.gitlab.com/ee/user/markdown.html#gitlab-flavored-markdown-gfm
[Setext-style heading]: #Setextheading
...
[^ghfmbks]: <https://github.github.com/gfm/#hard-line-break>
[^ghfmblq]: <https://github.github.com/gfm/#block-quotes>
[^ghfmcdi]: <https://github.github.com/gfm/#code-spans>
[^ghfmems]: <https://github.github.com/gfm/#emphasis-and-strong-emphasis>
[^ghfmfcb]: <https://github.github.com/gfm/#fenced-code-blocks>
[^ghfmhda]: <https://github.github.com/gfm/#atx-headings>
[^ghfmhds]: <https://github.github.com/gfm/#setext-headings>
[^ghfmht1]: <https://github.github.com/gfm/#raw-html>
[^ghfmht2]: <https://github.github.com/gfm/#disallowed-raw-html-extension->
[^ghfmicb]: <https://github.github.com/gfm/#indented-code-blocks>
[^ghfmimg]: <https://github.github.com/gfm/#images>
[^ghfmlst]: <https://github.github.com/gfm/#lists>
[^ghfmla1]: <https://github.github.com/gfm/#autolink>
[^ghfmla2]: <https://github.github.com/gfm/#autolinks-extension->
[^ghfmlki]: <https://github.github.com/gfm/#links>
[^ghfmlkr]: <https://github.github.com/gfm/#link-reference-definitions>
[^ghfmstk]: <https://github.github.com/gfm/#strikethrough-extension->
[^ghfmtbl]: <https://github.github.com/gfm/#tables-extension->
[^ghfmtbk]: <https://github.github.com/gfm/#thematic-break>
[^glfmbks]: <https://docs.gitlab.com/ee/user/markdown.html#newlines>
[^glfmblq]: <https://docs.gitlab.com/ee/user/markdown.html#multiline-blockquote>
[^glfmcdi]: <https://docs.gitlab.com/ee/user/markdown.html#code-and-syntax-highlighting>
[^glfmems]: <https://docs.gitlab.com/ee/user/markdown.html#emphasis>
[^glfmfcb]: <https://docs.gitlab.com/ee/user/markdown.html#code-and-syntax-highlighting>
[^glfmhdg]: <https://docs.gitlab.com/ee/user/markdown.html#headers>
[^glfmhtm]: <https://docs.gitlab.com/ee/user/markdown.html#inline-html>
[^glfmicb]: <https://docs.gitlab.com/ee/user/markdown.html#code-and-syntax-highlighting>
[^glfmimg]: <https://docs.gitlab.com/ee/user/markdown.html#images>
[^glfmlnk]: <https://docs.gitlab.com/ee/user/markdown.html#links>
[^glfmlst]: <https://docs.gitlab.com/ee/user/markdown.html#lists>
[^glfmrsf]: <https://docs.gitlab.com/ee/user/markdown.html#footnotes>
[^glfmskt]: <https://docs.gitlab.com/ee/user/markdown.html#emphasis>
[^glfmtbk]: <https://docs.gitlab.com/ee/user/markdown.html#horizontal-rule>
[^glfmtbl]: <https://docs.gitlab.com/ee/user/markdown.html#tables>
